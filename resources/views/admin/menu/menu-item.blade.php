...
<li class="dd-item dd3-item" data-id="{{$item["id"]}}">
    ...
    <div class="dd3-content {{$item["url"] == "javascript:;" ? "font-weight-bold" : ""}}">
        ...
        <a href="{{route('eliminar_menu', ['id' => $item["id"]])}}" class="eliminar-menu float-right tooltipsC" title="Eliminar este menú"><i class="float-right fa fa-fw fa-trash text-danger"></i></a>
    </div>
</li>
@else
<li class="dd-item dd3-item" data-id="{{$item["id"]}}">
